...
echo "Running newman"
newman run MF-Screens.postman_collection.json -e mf-screens.postman_environment.json --reporters cli,junit --reporter-junit-export ../../results/api-test/api-test-results.xml --disable-unicode
status=$?
