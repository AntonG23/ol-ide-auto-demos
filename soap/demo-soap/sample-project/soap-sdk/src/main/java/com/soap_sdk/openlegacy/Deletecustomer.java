...
@Getter
@Setter
@RpcEntity(name="Deletecustomer", displayName="Deletecustomer", language=Languages.WSDL)
@RpcActions(actions = {
...
public class Deletecustomer implements org.openlegacy.core.rpc.RpcEntity {
    ...
    public RpcEntityDefinition entityDefinition() {
        return DeletecustomerEntityHelper.entityDefinition;
    }

    @NotNull
    @Override
    public RpcEntityDefinition inputEntityDefinition() {
        return DeletecustomerEntityHelper.inputEntityDefinition;
    }

    @NotNull
    @Override
    public RpcEntityDefinition outputEntityDefinition() {
        return DeletecustomerEntityHelper.outputEntityDefinition;
    }

    @NotNull
    @Override
    public JsonObject toJsonObject() {
        return DeletecustomerEntityHelper.toJson(this);
    }

    @Override
    public void populateFromJson(@NotNull JsonObject jsonObject) {
        DeletecustomerEntityHelper.populateFromJson(jsonObject, this);
    }
