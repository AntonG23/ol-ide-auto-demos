...
echo "Running newman"
newman run Mainframe-IMS-Fin2.postman_collection.json -e mainframe-ims-fin2-env.postman_environment.json --reporters cli,junit --reporter-junit-export ../../results/api-test/api-test-results.xml --disable-unicode
status=$?
