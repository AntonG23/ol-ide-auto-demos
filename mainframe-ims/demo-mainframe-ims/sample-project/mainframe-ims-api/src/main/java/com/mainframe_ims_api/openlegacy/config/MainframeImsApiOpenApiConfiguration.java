package com.mainframe_ims_api.openlegacy.config;
 ...
 */
@Configuration
public class MainframeImsApiOpenApiConfiguration {
    ...
    public OpenAPI openApiConfiguration() {
        return new OpenAPI()
                .info(new Info()
                        .title("mainframe-ims-api")
                        .description("mainframe-ims-api API")
                        .version("0.1"))
