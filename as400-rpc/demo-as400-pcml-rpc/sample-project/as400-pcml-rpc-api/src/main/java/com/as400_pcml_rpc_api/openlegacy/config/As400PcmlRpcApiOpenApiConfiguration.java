package com.as400_pcml_rpc_api.openlegacy.config;
 ...
 */
@Configuration
public class As400PcmlRpcApiOpenApiConfiguration {
    ...
    public OpenAPI openApiConfiguration() {
        return new OpenAPI()
                .info(new Info()
                        .title("as400-pcml-rpc-api")
                        .description("as400-pcml-rpc-api API")
                        .version("0.1"))
