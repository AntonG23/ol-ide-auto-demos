package com.as400_cobol_rpc_api.openlegacy.config;
 ...
 */
@Configuration
public class As400CobolRpcApiOpenApiConfiguration {
    ...
    public OpenAPI openApiConfiguration() {
        return new OpenAPI()
                .info(new Info()
                        .title("as400-cobol-rpc-api")
                        .description("as400-cobol-rpc-api API")
                        .version("0.1"))
