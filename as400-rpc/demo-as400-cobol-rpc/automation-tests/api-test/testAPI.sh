...
echo "Running newman"
newman run AS400-COBOL-RPC.postman_collection.json -e as400-cobol-rpc-item.postman_environment.json --reporters cli,junit --reporter-junit-export ../../results/api-test/api-test-results.xml --disable-unicode
status=$?
