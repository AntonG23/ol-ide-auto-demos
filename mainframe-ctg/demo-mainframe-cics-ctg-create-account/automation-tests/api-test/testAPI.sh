...
echo "Running newman"
newman run Mainframe-CICS-TG-Create-Account.postman_collection.json -e mainframe-ctg-create-account.postman_environment.json --reporters cli,junit --reporter-junit-export ../../results/api-test/api-test-results.xml --disable-unicode
status=$?
