...
echo "Running newman"
newman run Mainframe-CICS-TG.postman_collection.json -e mainframe-cics-tg.postman_environment.json --reporters cli,junit --reporter-junit-export ../../results/api-test/api-test-results.xml --disable-unicode
status=$?
