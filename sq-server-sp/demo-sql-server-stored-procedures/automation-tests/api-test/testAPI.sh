...
echo "Running newman"
newman run SQL-Server-Stored-Procedures.postman_collection.json -e sql-server-sp-env.postman_environment.json --reporters cli,junit --reporter-junit-export ../../results/api-test/api-test-results.xml --disable-unicode
status=$?
